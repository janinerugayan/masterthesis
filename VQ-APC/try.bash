...
python VQ-APC_downstream_try.py --exp_name=8-mar_phoneseg \
...
--phoneseg_interval_dir=./results/8-mar_phoneseg/intervals/ \
--output_dir=./results/8-mar_wordseg

conda activate vq-apc

python VQ-APC_split_wav.py --preprocessed_wav_path=./preprocessed/8-mar_phoneseg/ \
--wordseg_interval_dir=./results/8-mar_wordseg/intervals/ \
--output_dir=./results/8-mar_wordseg

python VQ-APC_stt_recog.py --wav_path=./results/8-mar_wordseg/wavs \
--output_dir=./results/8-mar_wordseg
